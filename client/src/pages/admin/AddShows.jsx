        ...
        <>
            ...
            <div className="overflow-x-auto pb-4">
                <div className="group flex flex-wrap gap-4 mt-4 w-max">
                    {nowPlayingMovies.map((movie) => (
                        <div key={movie.id} onClick={() => setSelectedMovie(movie.id)} className={`relative max-w-40 cursor-pointer group-hover:not-hover:opacity-40 hover:-translate-y-1 transition duratiokn-300`}>
            ...
            <div className="mt-6">
                ...
                <div className="inline-flex gap-5 border border-gray-600 p-1 pl-3 rounded-lg">
                    {/* <p className="text-gray-400 text-sm">{currency}</p> */}
                    <input type="datetime-local" min={0} value={dateTimeInput} onChange={(e) => setDateTimeInput(e.target.value)} className='rounded-md outline-none' />
